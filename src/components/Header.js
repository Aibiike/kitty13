            ...
            <nav className="flex items-center justify-between flex-wrap  p-6">
                <div className="flex items-center flex-no-shrink text-white mr-6">
                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                         width="40" height="40" viewBox="0 0 1046.000000 1280.000000"
...
41 61 84 121 42 61 88 131 103 156 l26 46 143 -19 c78 -10 239 -34 357 -54z"/>
                    ...
                    <span className=" mx-5 font-semibold text-xl tracking-tight text-3xl">Kitty</span>
                </div>
                ...
                <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                    <div className="text-sm lg:flex-grow">
                        <Link to="/"
                           className="block mt-4 lg:inline-block lg:mt-0 text-teal-lighter hover:text-white mr-4 text-xl">
                            Home
                        </Link>
                        <Link to="/random"
                           className="block mt-4 lg:inline-block lg:mt-0 text-teal-lighter hover:text-white mr-4 text-xl">
                        ...
                        <Link to="/breeds"
                           className="block mt-4 lg:inline-block lg:mt-0 text-teal-lighter hover:text-white text-xl">
                            Breeds
                        </Link>
                    </div>
